...
export default function DashboardLayout({ children, onSignOut, userName, user, onExport, exportState, aiSource }) {
  return (
    <div className="bg-background text-on-surface min-h-screen" style={{ position: 'relative' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <TopNavBar user={user} onExport={onExport} exportState={exportState} aiSource={aiSource} />
