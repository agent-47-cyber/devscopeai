...
Return ONLY a strict JSON object (no markdown, no extra text):
{
  ...
  "technologyCoverage": "string — how well the tech stack serves ${targetRole} requirements",
  ...
  "bestRepository": "string — name of the repo showing the most complex ${targetRole} engineering",
  "weakestRepository": "string — repo that dilutes the portfolio signal",
  ...
  "openSourcePresence": "string — assessment of open-source contributions",
